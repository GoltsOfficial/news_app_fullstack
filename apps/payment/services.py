...
class StripeService:
        ...
        try:
            ...
            session = stripe.checkout.Session.create(
                ...
                metadata={
                    ...
                    "subscription_id": (
                        payment.subscription.id if payment.subscription else None
                    ),
                },
            )
    ...
    @staticmethod
    def refund_payment(
        payment: Payment, amount: Optional[Decimal] = None, reason: str = ""
    ) -> bool:
        ...
        try:
            ...
            refund_data = {
                ...
                "metadata": {"payment_id": payment.id, "reason": reason},
            }
